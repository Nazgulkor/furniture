...
!(function (t, e) {
  ...
  (x.fn = x.prototype =
          ...
          if (null != (t = arguments[a]))
            for (e in t)
              (o = t[e]),
                "__proto__" !== e &&
                  r !== o &&
                  (c && o && (x.isPlainObject(o) || (i = Array.isArray(o)))
                    ? ((n = r[e]),
                      (s =
                        i && !Array.isArray(n)
                          ? []
    ...
    x.extend({
      ...
      grep: function (t, e, n) {
        for (var o = [], i = 0, s = t.length, r = !n; i < s; i++)
          !e(t[i], i) !== r && o.push(t[i]);
        return o;
      },
      map: function (t, e, n) {
        var o,
  ...
  var S =
    ...
    (function (t) {
      ...
      try {
        N.apply((P = M.call(x.childNodes)), x.childNodes),
        ...
        if (!i && (p(e), (e = e || f), g)) {
          if (11 !== x && (u = J.exec(t)))
            if ((s = u[1])) {
              ...
              if (u[2]) return N.apply(o, e.getElementsByTagName(t)), o;
              if (
                (s = u[3]) &&
                n.getElementsByClassName &&
                e.getElementsByClassName
              )
                return N.apply(o, e.getElementsByClassName(s)), o;
            }
          if (
            n.qsa &&
            !E[t + " "] &&
            ...
            if (((y = t), (v = e), 1 === x && (U.test(t) || W.test(t)))) {
              for (
                ((v = (tt.test(t) && yt(e.parentNode)) || e) === e &&
                  n.scope) ||
                  ((d = e.getAttribute("id"))
                    ? (d = d.replace(ot, it))
      ...
      function mt(t) {
        return ct(function (e) {
          return (
            (e = +e),
            ct(function (n, o) {
              for (var i, s = t([], n.length, e), r = s.length; r--; )
                n[(i = s[r])] && (n[i] = !(o[i] = n[i]));
            })
          );
        });
                    ...
                    if (void 0 !== e.getElementById && g) {
                      ...
                      if (s) {
                        if ((n = s.getAttributeNode("id")) && n.value === t)
                          return [s];
                        for (i = e.getElementsByName(t), o = 0; (s = i[o++]); )
                          if ((n = s.getAttributeNode("id")) && n.value === t)
                            return [s];
                      }
                      return [];
      ...
      (at.attr = function (t, e) {
        ...
        var i = o.attrHandle[e.toLowerCase()],
          s = i && D.call(o.attrHandle, e.toLowerCase()) ? i(t, e, !g) : void 0;
        return void 0 !== s
          ? s
          : n.attributes || !g
          ? t.getAttribute(e)
              ...
              return i[w]
                ...
                ? ((n = [t, t, "", e]),
                  o.setFilters.hasOwnProperty(t.toLowerCase())
                    ? ct(function (t, n) {
                        for (var o, s = i(t, e), r = s.length; r--; )
                          t[(o = R(t, s[r]))] = !(n[o] = s[r]);
                      })
                    : function (t) {
                        return i(t, 0, n);
      ...
      function Ct(t, e, n, o, i) {
        for (var s, r = [], a = 0, l = t.length, c = null != e; a < l; a++)
          (s = t[a]) && ((n && !n(s, o, i)) || (r.push(s), c && e.push(a)));
        return r;
      }
      function St(t, e, n, o, i, s) {
        return (
          o && !o[w] && (o = St(o)),
          i && !i[w] && (i = St(i, s)),
          ct(function (s, r, a, l) {
            var c,
              ...
              y = n ? (i || (s ? t : h || o) ? [] : r) : m;
            if ((n && n(m, y, a, l), o))
              for (c = Ct(y, f), o(c, [], a, l), d = c.length; d--; )
                (u = c[d]) && (y[f[d]] = !(m[f[d]] = u));
            if (s) {
              if (i || t) {
                if (i) {
            ...
            } else (y = Ct(y === r ? y.splice(h, y.length) : y)), i ? i(null, r, y, l) : N.apply(r, y);
          })
        );
      }
      function Tt(t) {
        for (
          ...
          if ((n = o.relative[t[l].type])) p = [wt(xt(p), n)];
          else {
            if ((n = o.filter[t[l].type].apply(null, t[l].matches))[w]) {
      ...
      return (
        (vt.prototype = o.filters = o.pseudos),
        (o.setFilters = new vt()),
        (r = at.tokenize =
          function (t, e) {
            var n,
          ...
          function (t, e, n, i) {
            ...
            if (((n = n || []), 1 === f.length)) {
              if (
                ...
                if (
                  !(e = (o.find.ID(c.matches[0].replace(et, nt), e) || [])[0])
                )
                  return n;
              ...
              for (
                ...
                if (
                  ...
                  if ((l.splice(s, 1), !(t = i.length && bt(l))))
  ...
  (x.filter = function (t, e, n) {
    ...
    x.fn.extend({
      ...
      is: function (t) {
        return !!D(this, "string" == typeof t && A.test(t) ? x(t) : t || [], !1)
          .length;
      },
    });
  var P,
    ...
    if (((n = n || P), "string" == typeof t)) {
      ...
      if (o[1]) {
        if (
          ...
          x.merge(
            this,
            x.parseHTML(o[1], e && e.nodeType ? e.ownerDocument || e : m, !0)
          ),
          $.test(o[1]) && x.isPlainObject(e))
        )
          for (o in e) h(this[o]) ? this[o](e[o]) : this.attr(o, e[o]);
        return this;
      }
      return (
        (i = m.getElementById(o[2])) && ((this[0] = i), (this.length = 1)), this
      );
    }
    return t.nodeType
      ...
      function (t, e) {
        x.fn[t] = function (n, o) {
          ...
          return (
            ...
            this.length > 1 &&
              (N[t] || x.uniqueSort(i), I.test(t) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
  ...
  (x.Callbacks = function (t) {
    ...
    var e,
      ...
      a = -1,
      l = function () {
        for (i = i || t.once, o = e = !0; r.length; a = -1)
        ...
        var n = [
          ...
          i = {
            ...
            then: function (e, o, i) {
              ...
              return x
                .Deferred(function (t) {
                  n[0][3].add(r(0, t, h(i) ? i : L, t.notifyWith)),
                    n[1][3].add(r(0, t, h(e) ? e : L)),
                    n[2][3].add(r(0, t, h(o) ? o : F));
                })
                .promise();
            },
            promise: function (t) {
      ...
      when: function (t) {
        var e = arguments.length,
          ...
          a = function (t) {
            return function (n) {
              (o[t] = this),
                (s[t] = arguments.length > 1 ? i.call(arguments) : n),
                --e || r.resolveWith(o, s);
            };
          };
        if (
          e <= 1 &&
          (j(t, r.done(a(n)).resolve, r.reject, !e),
  ...
  var z = function (t, e, n, o, i, s, r) {
      var a = 0,
        l = t.length,
        c = null == n;
      if ("object" === b(n))
        for (a in ((i = !0), n)) z(t, e, a, n[a], !0, s, r);
      else if (
        void 0 !== o &&
        ((i = !0),
        h(o) || (r = !0),
        ...
        for (; a < l; a++) e(t[a], n, r ? o : o.call(t[a], a, e(t[a], n)));
  ...
  function X(t) {
    return t.replace(_, "ms-").replace(W, U);
  }
  var Y = function (t) {
  ...
  function J(t, e, n) {
    ...
    if (void 0 === n && 1 === t.nodeType)
      if (
        ((o = "data-" + e.replace(Q, "-$&").toLowerCase()),
    ...
    x.fn.extend({
      data: function (t, e) {
        ...
        if (void 0 === t) {
          if (
            this.length &&
            ((i = Z.get(s)), 1 === s.nodeType && !V.get(s, "hasDataAttrs"))
          ) {
            for (n = r.length; n--; )
              r[n] &&
                0 === (o = r[n].name).indexOf("data-") &&
                ((o = X(o.slice(5))), J(s, o, i[o]));
  ...
  var rt = function (t, e) {
    return (
      ...
      ("" === t.style.display && it(t) && "none" === x.css(t, "display"))
    );
  };
  function at(t, e, n, o) {
    var i,
  ...
  function dt(t, e) {
    for (var n, o, i = [], s = 0, r = t.length; s < r; s++)
      (o = t[s]).style &&
        ((n = o.style.display),
        e
          ? ("none" === n &&
              ((i[s] = V.get(o, "display") || null),
              i[s] || (o.style.display = "")),
            "" === o.style.display && rt(o) && (i[s] = ct(o)))
          : "none" !== n && ((i[s] = "none"), V.set(o, "display", n)));
    for (s = 0; s < r; s++) null != i[s] && (t[s].style.display = i[s]);
    return t;
  }
  x.fn.extend({
    show: function () {
  ...
  (ut = m.createDocumentFragment().appendChild(m.createElement("div"))),
    (pt = m.createElement("input")).setAttribute("type", "radio"),
  ...
  function wt(t, e, n, o, i) {
    ...
    for (u.textContent = "", f = 0; (s = p[f++]); )
      if (o && x.inArray(s, o) > -1) i && i.push(s);
      else if (
        ((c = it(s)), (r = yt(u.appendChild(s), "script")), c && vt(r), n)
      )
        for (d = 0; (s = r[d++]); ) gt.test(s.type || "") && n.push(s);
    return u;
  }
  var xt = /^([^.]*)(?:\.(.+)|)/;
  function Ct() {
  ...
  function At(t, e, n) {
    n
          ...
          handler: function (t) {
            ...
            if (1 & t.isTrigger && this[e]) {
              if (r.length)
                ...
                (o = n(this, e)),
                this[e](),
                r !== (s = V.get(this, e)) || o ? V.set(this, e, !1) : (s = {}),
                r !== s)
              )
                return (
      ...
      : void 0 === V.get(t, e) && x.event.add(t, e, Ct);
  }
  (x.event = {
    global: {},
          ...
          (f = g = (a = xt.exec(e[c]) || [])[1]),
            ...
            f &&
              ...
              (p = l[f]) ||
                ...
                (u.setup && !1 !== u.setup.call(t, o, h, r)) ||
        ...
        for (c = (e = (e || "").match(R) || [""]).length; c--; )
          if (
            ...
            r &&
              ...
              delete l[f]);
          } else for (f in l) x.event.remove(t, f + e[c], n, o, !0);
    ...
    dispatch: function (t) {
      ...
      if (
        ...
        for (
          r = x.event.handlers.call(this, l, c), e = 0;
    ...
    special: {
      ...
      click: {
        setup: function (t) {
          var e = this || t;
          return (
            ft.test(e.type) && e.click && E(e, "input") && At(e, "click", Ct),
            !1
          );
        },
        trigger: function (t) {
          var e = this || t;
          return (
            ft.test(e.type) && e.click && E(e, "input") && At(e, "click"), !0
          );
        },
        _default: function (t) {
          var e = t.target;
    ...
    x.fn.extend({
      on: function (t, e, n, o) {
        return kt(this, t, e, n, o);
      },
      one: function (t, e, n, o) {
        return kt(this, t, e, n, o, 1);
      },
      off: function (t, e, n) {
        var o, i;
  ...
  function Nt(t, e) {
    ...
    if (1 === e.nodeType) {
      ...
      Z.hasData(t) && ((s = Z.access(t)), (r = x.extend({}, s)), Z.set(e, r));
    }
  }
  function Mt(t, e) {
    var n = e.nodeName.toLowerCase();
  ...
  function Rt(t, e, n, o) {
    ...
    var i,
      ...
      m = e[0],
      y = h(m);
    if (y || (p > 1 && "string" == typeof m && !f.checkClone && $t.test(m)))
      return t.each(function (i) {
        var s = t.eq(i);
        y && (e[0] = m.call(this, i, s.html())), Rt(s, e, n, o);
      });
    if (
      p &&
      ((r = (i = wt(e, t[0].ownerDocument, !1, t, o)).firstChild),
      1 === i.childNodes.length && (i = r),
      r || o)
    ) {
      for (l = (a = x.map(yt(i, "script"), Ot)).length; u < p; u++)
        (c = i),
          u !== g &&
            ((c = x.clone(c, !0, !0)), l && x.merge(a, yt(c, "script"))),
          n.call(t[u], c, u);
      if (l)
        for (d = a[a.length - 1].ownerDocument, x.map(a, It), u = 0; u < l; u++)
          (c = a[u]),
            gt.test(c.type || "") &&
              ...
              (c.src && "module" !== (c.type || "").toLowerCase()
                ...
                : v(c.textContent.replace(Dt, ""), c, d));
    }
    return t;
  }
  function Lt(t, e, n) {
    for (var o, i = e ? x.filter(e, t) : t, s = 0; null != (o = i[s]); s++)
      n || 1 !== o.nodeType || x.cleanData(yt(o)),
        o.parentNode &&
          (n && it(o) && vt(yt(o, "script")), o.parentNode.removeChild(o));
    return t;
  }
  x.extend({
    ...
    clone: function (t, e, n) {
      ...
      if (
        ...
        for (r = yt(a), o = 0, i = (s = yt(t)).length; o < i; o++)
          Mt(s[o], r[o]);
      if (e)
        if (n)
          for (s = s || yt(t), r = r || yt(a), o = 0, i = s.length; o < i; o++)
            Nt(s[o], r[o]);
        else Nt(t, a);
      return (
        (r = yt(a, "script")).length > 0 && vt(r, !l && yt(t, "script")), a
      );
    },
    cleanData: function (t) {
      for (var e, n, o, i = x.event.special, s = 0; void 0 !== (n = t[s]); s++)
        if (Y(n)) {
          if ((e = n[V.expando])) {
            if (e.events)
              for (o in e.events)
                i[o] ? x.event.remove(n, o) : x.removeEvent(n, o, e.handle);
            n[V.expando] = void 0;
          }
        ...
        return z(
          ...
          function (t) {
            ...
            if (
              "string" == typeof t &&
              !Et.test(t) &&
              !mt[(ht.exec(t) || ["", ""])[1].toLowerCase()]
            ) {
              t = x.htmlPrefilter(t);
              try {
                for (; n < o; n++)
                  1 === (e = this[n] || {}).nodeType &&
                    (x.cleanData(yt(e, !1)), (e.innerHTML = t));
                e = 0;
              } catch (t) {}
            }
      ...
      replaceWith: function () {
        ...
        return Rt(
          ...
          function (e) {
            ...
            x.inArray(this, t) < 0 &&
              (x.cleanData(yt(this)), n && n.replaceChild(e, this));
          },
          t
        );
      },
    ...
    x.each(
      ...
      function (t, e) {
        x.fn[t] = function (t) {
          for (var n, o = [], i = x(t), s = i.length - 1, a = 0; a <= s; a++)
  ...
  var Ft = new RegExp("^(" + tt + ")(?!px)[a-z%]+$", "i"),
    ...
    Bt = function (t, e, n) {
      ...
      for (i in ((o = n.call(t)), e)) t.style[i] = s[i];
      return o;
    },
    ...
    function e() {
      if (d) {
        (c.style.cssText =
          ...
          ot.appendChild(c).appendChild(d);
        ...
        reliableTrDimensions: function () {
          ...
          return (
            null == a &&
              ...
              ot.appendChild(e).appendChild(n).appendChild(o),
    ...
    return (
      ...
      (t in Wt
        ...
        : (Ut[t] =
            (function (t) {
              for (
                var e = t[0].toUpperCase() + t.slice(1), n = _t.length;
                n--;

              )
                if ((t = _t[n] + e) in Wt) return t;
            })(t) || t))
    );
  }
  ...
  function Qt(t, e, n, o, i, s) {
    ...
    for (; r < 4; r += 2)
      "margin" === n && (l += x.css(t, n + nt[r], !0, i)),
        o
          ? ("content" === n && (l -= x.css(t, "padding" + nt[r], !0, i)),
            "margin" !== n &&
              (l -= x.css(t, "border" + nt[r] + "Width", !0, i)))
          : ((l += x.css(t, "padding" + nt[r], !0, i)),
            "padding" !== n
              ? (l += x.css(t, "border" + nt[r] + "Width", !0, i))
              : (a += x.css(t, "border" + nt[r] + "Width", !0, i)));
    return (
      !o &&
        s >= 0 &&
        (l +=
  ...
  function Jt(t, e, n) {
    var o = jt(t),
      i =
        ...
        "border-box" === x.css(t, "boxSizing", !1, o),
      s = i,
      r = qt(t, e, o),
    ...
    return (
      ((!f.boxSizingReliable() && i) ||
        ...
        "auto" === r ||
        (!parseFloat(r) && "inline" === x.css(t, "display", !1, o))) &&
        t.getClientRects().length &&
        ((i = "border-box" === x.css(t, "boxSizing", !1, o)),
        (s = a in t) && (r = t[a])),
      (r = parseFloat(r) || 0) +
        Qt(t, e, n || (i ? "border" : "content"), s, o, r) +
        "px"
    );
  }
  ...
  x.extend({
    ...
    style: function (t, e, n, o) {
      if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
        var i,
          ...
          c = t.style;
        if (
          (l || (e = Xt(a)), (r = x.cssHooks[e] || x.cssHooks[a]), void 0 === n)
        )
          return r && "get" in r && void 0 !== (i = r.get(t, !1, o)) ? i : c[e];
        "string" === (s = typeof n) &&
          (i = et.exec(n)) &&
          i[1] &&
          ((n = at(t, e, i)), (s = "number")),
    ...
    x.each(["height", "width"], function (t, e) {
      x.cssHooks[e] = {
        get: function (t, n, o) {
          if (n)
            return !Yt.test(x.css(t, "display")) ||
        ...
        set: function (t, n, o) {
          var i,
            ...
            a = (r || o) && "border-box" === x.css(t, "boxSizing", !1, s),
            l = o ? Qt(t, e, o, a, s) : 0;
          return (
            a &&
              r &&
    ...
    (x.cssHooks.marginLeft = zt(f.reliableMarginLeft, function (t, e) {
      if (e)
        return (
      ...
      _default: {
        ...
        set: function (t) {
          x.fx.step[t.prop]
            ? x.fx.step[t.prop](t)
            : 1 !== t.elem.nodeType ||
              (!x.cssHooks[t.prop] && null == t.elem.style[Xt(t.prop)])
            ? (t.elem[t.prop] = t.now)
      ...
      !(function (t, e) {
        ...
        for (n in t)
          if (
            ((i = e[(o = X(n))]),
            (s = t[n]),
            Array.isArray(s) && ((i = s[1]), (s = t[n] = s[0])),
            n !== o && ((t[o] = s), delete t[n]),
            (r = x.cssHooks[o]) && ("expand" in r))
          )
            for (n in ((s = r.expand(s)), delete t[o], s))
              (n in t) || ((t[n] = s[n]), (e[n] = i));
          else e[o] = i;
      })(d, c.opts.specialEasing);
      s < r;
      s++
    )
      if ((o = ce.prefilters[s].call(c, t, d, c.opts)))
        return (
          h(o.stop) &&
        ...
        if ((l = !x.isEmptyObject(e)) || !x.isEmptyObject(f))
          ...
          f))
            l ||
              ...
              g && dt([t], !0),
              p.done(function () {
                for (o in (g || dt([t]), V.remove(t, "fxshow"), f))
                  x.style(t, o, f[o]);
              })),
              (l = le(g ? m[o] : 0, o, p)),
              o in m ||
      ...
      stop: function (t, e, n) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (i in r) r[i] && r[i].stop && ie.test(i) && o(r[i]);
            for (i = s.length; i--; )
              s[i].elem !== this ||
                (null != t && s[i].queue !== t) ||
                (s[i].anim.stop(n), (e = !1), s.splice(i, 1));
      ...
      return arguments.length
        ? ((o = h(t)),
          this.each(function (n) {
            var i;
            1 === this.nodeType &&
              (null == (i = o ? t.call(this, n, x(this).val()) : t)
                ? (i = "")
                : "number" == typeof i
                ? (i += "")
                : Array.isArray(i) &&
        ...
        : i
        ? (e = x.valHooks[i.type] || x.valHooks[i.nodeName.toLowerCase()]) &&
          "get" in e &&
    ...
    x.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (t, e) {
            for (
              var n, o, i = t.options, s = x.makeArray(e), r = i.length;
              r--;

            )
              ((o = i[r]).selected =
                x.inArray(x.valHooks.option.get(o), s) > -1) && (n = !0);
  ...
  x.extend(x.event, {
    trigger: function (e, n, o, i) {
      ...
      if (
        ...
        3 !== o.nodeType &&
          ...
          ((e = e[x.expando]
            ? e
            : new x.Event(v, "object" == typeof e && e)).isTrigger = i ? 2 : 3),
          (e.namespace = b.join(".")),
        ...
        if (!i && !p.noBubble && !g(o)) {
          for (
            l = p.delegateType || v, ve.test(l + v) || (r = r.parentNode);
            r;
            r = r.parentNode
          )
            y.push(r), (a = r);
          a === (o.ownerDocument || m) &&
            y.push(a.defaultView || a.parentWindow || t);
        }
    ...
    simulate: function (t, e, n) {
      var o = x.extend(new x.Event(), n, { type: t, isSimulated: !0 });
        ...
        x.event.special[e] = {
          setup: function () {
            var o = this.ownerDocument || this.document || this,
              i = V.access(o, e);
            i || o.addEventListener(t, n, !0), V.access(o, e, (i || 0) + 1);
          },
          teardown: function () {
            var o = this.ownerDocument || this.document || this,
              i = V.access(o, e) - 1;
            i
              ? V.access(o, e, i)
              : (o.removeEventListener(t, n, !0), V.remove(o, e));
          },
        };
      });
  var we = t.location,
  ...
  function Ee(t, e, n, o) {
    ...
    else for (i in e) Ee(t + "[" + i + "]", e[i], n, o);
  }
        ...
        if (
          ...
          try {
            (l.href = f.url),
              (l.href = l.href),
              (f.crossDomain =
                Fe.protocol + "//" + Fe.host != l.protocol + "//" + l.host);
          } catch (t) {
            f.crossDomain = !0;
          }
        }
        ...
        f.hasContent
          ...
          : ((p = f.url.slice(i.length)),
            f.data &&
              ...
              ((i += (Ce.test(i) ? "&" : "?") + f.data), delete f.data),
            !1 === f.cache &&
              ((i = i.replace(Pe, "$1")),
              (p = (Ce.test(i) ? "&" : "?") + "_=" + xe.guid++ + p)),
            (f.url = i + p)),
        f.ifModified &&
          (x.lastModified[i] &&
        ...
        function k(e, n, r, l) {
          ...
          c ||
            ...
            r &&
              (w = (function (t, e, n) {
                for (
                  var o, i, s, r, a = t.contents, l = t.dataTypes;
                  "*" === l[0];
            ...
            u
              ? (f.ifModified &&
                  ((C = T.getResponseHeader("Last-Modified")) &&
                    (x.lastModified[i] = C),
                  (C = T.getResponseHeader("etag")) && (x.etag[i] = C)),
                204 === e || "HEAD" === f.type
                  ? (S = "nocontent")
                  : 304 === e
                  ? (S = "notmodified")
                  : ((S = w.state), (p = w.data), (u = !(m = w.error))))
    ...
    x.each(["get", "post"], function (t, e) {
      x[e] = function (t, n, o, i) {
        return (
          ...
          x.ajax(
            x.extend(
              { url: t, type: e, dataType: i, data: n, success: o },
              x.isPlainObject(t) && t
            )
          )
        );
  ...
  x.ajaxSetup({
    ...
    jsonpCallback: function () {
      var t = We.pop() || x.expando + "_" + xe.guid++;
      return (this[t] = !0), t;
    },
  }),
    x.ajaxPrefilter("json jsonp", function (e, n, o) {
      ...
      if (a || "jsonp" === e.dataTypes[0])
        return (
          ...
          o.always(function () {
            void 0 === s ? x(t).removeProp(i) : (t[i] = s),
              e[i] && ((e.jsonpCallback = n.jsonpCallback), We.push(i)),
              r && h(s) && s(r[0]),
              (r = s = void 0);
          }),
          "script"
    ...
    (f.createHTMLDocument =
      (((_e = m.implementation.createHTMLDocument("").body).innerHTML =
        "<form></form><form></form>"),
    ...
    (x.fn.load = function (t, e, n) {
      var o,
        ...
        a = t.indexOf(" ");
      return (
        a > -1 && ((o = he(t.slice(a))), (t = t.slice(0, a))),
        h(e)
          ? ((n = e), (e = void 0))
    ...
    (x.offset = {
      setOffset: function (t, e, n) {
        ...
        "static" === c && (t.style.position = "relative"),
          ...
          null != e.left && (u.left = e.left - a.left + i),
    ...
    x.each(["top", "left"], function (t, e) {
      x.cssHooks[e] = zt(f.pixelPosition, function (t, n) {
        if (n)
          return (n = qt(t, e)), Ft.test(n) ? x(t).position()[e] + "px" : n;
      });
    }),
  ...
  return (
    (x.noConflict = function (e) {
      return t.$ === x && (t.$ = Ge), e && t.jQuery === x && (t.jQuery = Ye), x;
    }),
    ...
    (e = 0),
              ...
              t({ animStart: i.currentLeft }).animate(
                { animStart: e },
                {
                  ...
                  step: function (t) {
                    (t = Math.ceil(t)),
                      !1 === i.options.vertical
                        ? ((o[i.animType] = "translate(" + t + "px, 0px)"),
                          i.$slideTrack.css(o))
                        : ((o[i.animType] = "translate(0px," + t + "px)"),
                          i.$slideTrack.css(o));
                  },
                  complete: function () {
                    n && n.call();
        ...
        if (!0 === o.options.dots && o.slideCount > o.options.slidesToShow) {
          for (
            o.$slider.addClass("slick-dotted"),
              n = t("<ul />").addClass(o.options.dotsClass),
              e = 0;
            e <= o.getDotCount();
            e += 1
          )
              ...
              s.slideCount % s.options.slidesToScroll != 0 &&
                ...
                (t > s.slideCount
                  ? ((s.slideOffset =
                      ...
                      -1),
                    (r =
                      (s.options.slidesToShow - (t - s.slideCount)) * n * -1))
                  : ((s.slideOffset =
        ...
        return (
          ...
          !0 === o.options.swipeToSlide
            ? (o.$slideTrack.find(".slick-slide").each(function (i, s) {
                if (s.offsetLeft - n + t(s).outerWidth() / 2 > -1 * o.swipeLeft)
                  return (e = s), !1;
              }),
        ...
        e.$slides
          ...
          null !== e.$dots &&
            (e.$slides
              ...
              .each(function (n) {
                ...
                if (
                  ...
                  var s = "slick-slide-control" + e.instanceUid + i;
            ...
            e.$dots
              ...
              .end());
        for (var i = e.currentSlide, s = i + e.options.slidesToShow; i < s; i++)
        ...
        if (
          (!0 === i.options.centerMode
            ? !0 === i.options.infinite
              ? (o =
                  (n = i.currentSlide + (i.options.slidesToShow / 2 + 1)) +
              ...
              : ((n = Math.max(
                ...
                (o = i.options.slidesToShow / 2 + 1 + 2 + i.currentSlide))
          ...
          (e = i.$slider.find(".slick-slide").slice(n, o)),
          "anticipated" === i.options.lazyLoad)
        )
          for (
            var r = n - 1, a = o, l = i.$slider.find(".slick-slide"), c = 0;
      ...
      (n.prototype.setCSS = function (t) {
        ...
        !0 === o.options.rtl && (t = -t),
          ...
          (n = "top" == o.positionProp ? Math.ceil(t) + "px" : "0px"),
          (i[o.positionProp] = t),
          !1 === o.transformsEnabled
            ? o.$slideTrack.css(i)
            : ((i = {}),
              !1 === o.cssTransitions
                ? ((i[o.animType] = "translate(" + e + ", " + n + ")"),
                  o.$slideTrack.css(i))
                : ((i[o.animType] = "translate3d(" + e + ", " + n + ", 0px)"),
                  o.$slideTrack.css(i)));
      }),
            ...
            for (n in i)
              if ("array" !== t.type(r.options.responsive))
                ...
                for (e = r.options.responsive.length - 1; e >= 0; )
                  r.options.responsive[e].breakpoint === i[n].breakpoint &&
            ...
            !a.options.verticalSwiping && !a.swiping && r > 4
              ...
              : (!0 === a.options.verticalSwiping &&
                ...
                !1 === a.options.vertical
                  ? (a.swipeLeft = e + o * i)
                  : (a.swipeLeft =
                      e + o * (a.$list.height() / a.listWidth) * i),
                !0 === a.options.verticalSwiping && (a.swipeLeft = e + o * i),
                !0 !== a.options.fade &&
        ...
        for (t = 0; t < r; t++)
          if (
            ("object" == typeof i || void 0 === i
              ? (o[t].slick = new n(o[t], i))
              : (e = o[t].slick[i].apply(o[t].slick, s)),
            void 0 !== e)
          )
            return e;
        return o;
  ...
  (function (t) {
    ...
    !(function () {
      var e = ["webkit", "moz", "o", "ms"],
        ...
        o = -1;
      for (o = 0; o < e.length && !t.requestAnimationFrame; o++)
        t.requestAnimationFrame = t[e[o] + "RequestAnimationFrame"];
          ...
          (Object.keys = (function () {
            ...
            return (
              ...
              function (i) {
                ...
                for (r in i) o.call(i, r) && s.push(r);
                if (t) for (a = 0; a < n; a++) o.call(i, e[a]) && s.push(e[a]);
                return s;
              }
            );
          })()),
        ...
        "function" != typeof Object.create &&
          (Object.create = (function (t) {
            ...
            return function (t, n) {
              ...
              return (
                (e.prototype = null),
                undefined !== n && Object.defineProperties(o, n),
                null === t && (o.__proto__ = null),
                o
              );
            };
          })()),
      ...
      (e = function (o, i, s) {
        ...
        if (
          ...
          f = d.querySelectorAll(o);
        else if (o && "object" == typeof o && n.isElement(o, d)) f = [o];
        else {
          if (!o || "object" != typeof o || !o.length)
        ...
        for (h = 0; (r = f[h]) && (!(h > 0) || a); h++)
          r.id ? (p = r.id) : ((p = "MixItUp" + n.randomHex()), (r.id = p)),
            e.instances[p] instanceof e.Mixer
              ...
              : ((l = new e.Mixer()).attach(r, d, p, i), (e.instances[p] = l)),
            (c = new e.Facade(l)),
            i && i.debug && i.debug.enable ? u.push(l) : u.push(c);
      ...
      (n = {
            ...
            for (r = 0; r < i.length; r++)
              (s = i[r]),
                !n || "object" != typeof e[s] || this.isElement(e[s])
                  ? (t[s] = e[s])
                  : Array.isArray(e[s])
                  ? (t[s] || (t[s] = []), this.extend(t[s], e[s], n, o))
                  : (t[s] || (t[s] = {}), this.extend(t[s], e[s], n, o));
          } catch (e) {
            if (!o) throw e;
        ...
        handleExtendError: function (t, n) {
          ...
          if (
            ...
            for (l in ((i = o[1]), n)) {
              for (d = 0; d < i.length && i.charAt(d) === l.charAt(d); ) d++;
              d > c && ((c = d), (a = l));
            }
            throw (
              (c > 1 &&
        ...
        template: function (t) {
          for (var e = /\${([\w]*)}/g, n = {}, o = null; (o = e.exec(t)); )
        ...
        getCustomEvent: function (e, n, o) {
          ...
          return (
            ...
            "function" == typeof t.CustomEvent
              ...
              ? (i = o.createEvent("CustomEvent")).initCustomEvent(e, !0, !0, n)
              : (((i = o.createEventObject()).type = e),
                (i.returnValue = !1),
                (i.cancelBubble = !1),
                (i.detail = n)),
            i
        ...
        arrayShuffle: function (t) {
          for (var e = t.slice(), n = e.length, o = n, i = -1, s = []; o--; )
            (i = ~~(Math.random() * n)), (s = e[o]), (e[o] = e[i]), (e[i] = s);
          return e;
        },
        ...
        position: function (t) {
          for (var e = 0, n = 0, o = t; t; )
            (e -= t.scrollLeft),
              (n -= t.scrollTop),
              t === o &&
                ((e += t.offsetLeft), (n += t.offsetTop), (o = t.offsetParent)),
              (t = t.parentElement);
          return { x: e, y: n };
        },
        ...
        closestParent: function (e, n, o, i) {
          var s = e.parentNode;
          if (((i = i || t.document), o && e.matches(n))) return e;
          for (; s && s != i.body; ) {
        ...
        all: function (n, o) {
          ...
          return e.features.has.promises
            ? Promise.all(n)
            : (i = t.jQuery || o.$) && "function" == typeof i.when
        ...
        compareVersions: function (t, e) {
          ...
          for (r = 0; r < n.length; r++) {
            if (
              ...
              (s = parseInt(o[r].replace(/[^\d.]/g, "") || 0)) < i)
            )
              return !1;
            if (s > i) return !0;
          }
      ...
      (e.Base.prototype = {
        ...
        callActions: function (t, e) {
          var o = this.constructor.actions[t],
            i = "";
          if (o && !n.isEmptyObject(o)) for (i in o) o[i].apply(this, e);
        },
        callFilters: function (t, e, o) {
          var i = this.constructor.filters[t],
            s = e,
            r = "";
          if (!i || n.isEmptyObject(i)) return s;
          for (r in ((o = o || []), i))
            (o = n.arrayFromList(o)).unshift(s), (s = i[r].apply(this, o));
          return s;
        },
      }),
      ...
      (e.ControlDefinition = function (t, o, i, s) {
        e.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.type = t),
          (this.selector = o),
      ...
      n.extend(e.Control.prototype, {
        ...
        removeBinding: function (t) {
          ...
          this.callActions("beforeRemoveBinding", arguments),
            (o = n.bound.indexOf(t)) > -1 && n.bound.splice(o, 1),
            n.bound.length < 1 &&
              (n.unbindClick(),
              (o = e.controls.indexOf(n)),
              e.controls.splice(o, 1),
        ...
        handleClick: function (t) {
          ...
          if (
            ...
            (i = o.selector
              ? n.closestParent(
                  t.target,
                  s.config.selectors.control + o.selector,
                  !0,
                  s.dom.document
                )
              : o.el))
            ...
            switch (o.type) {
              case "filter":
                a.filter = o.filter || i.getAttribute("data-filter");
                break;
              case "sort":
                a.sort = o.sort || i.getAttribute("data-sort");
                break;
              case "multimix":
                (a.filter = o.filter || i.getAttribute("data-filter")),
                  (a.sort = o.sort || i.getAttribute("data-sort"));
                break;
              case "toggle":
                (a.filter = o.filter || i.getAttribute("data-toggle")),
                  (r =
                    "live" === o.status
                      ? n.hasClass(i, o.classNames.active)
                      : "active" === o.status);
            }
            for (d = 0; d < o.bound.length; d++)
              (l = new e.CommandMultimix()), n.extend(l, a), c.push(l);
            for (
              c = o.callFilters("commandsHandleClick", c, arguments),
                o.pending = o.bound.length,
                d = 0;
              (s = o.bound[d]);
              d++
            )
              (a = c[d]) &&
                (s.lastClicked || (s.lastClicked = i),
                e.events.fire(
                  "mixClick",
                  s.dom.container,
                  {
          ...
          } else o.callActions("afterHandleClick", arguments);
        },
        update: function (t, n) {
          var o = this,
            ...
            o.pending > 0 ||
              ("live" === o.status
                ...
                : ((i.sort = o.sort),
                  ...
                  o.parseStatusChange(o.el, t, i, n)),
        ...
        updateLive: function (t, n) {
          ...
          if ((o.callActions("beforeUpdateLive", arguments), o.el)) {
            for (
              ...
              switch (((s = new e.CommandMultimix()), o.type)) {
                case "filter":
        ...
        renderStatus: function (t, e) {
          var o = this;
          switch ((o.callActions("beforeRenderStatus", arguments), e)) {
            case "active":
              n.addClass(t, o.classNames.active),
                n.removeClass(t, o.classNames.disabled),
                o.canDisable && (o.el.disabled = !1);
              break;
            case "inactive":
              n.removeClass(t, o.classNames.active),
                n.removeClass(t, o.classNames.disabled),
                o.canDisable && (o.el.disabled = !1);
              break;
            case "disabled":
              o.canDisable && (o.el.disabled = !0),
                n.addClass(t, o.classNames.disabled),
                n.removeClass(t, o.classNames.active);
          }
          "live" !== o.status && (o.status = e),
            o.callActions("afterRenderStatus", arguments);
        },
      }),
      (e.controls = []),
      ...
      (e.Events.prototype.fire = function (t, o, i, s) {
        var r = this,
          a = null,
          l = new e.EventDetail();
      ...
      n.extend(e.Mixer.prototype, {
        ...
        getInitialState: function () {
          ...
          if (
            ...
            (n.activeFilter = t.parseFilterArgs([
              ...
              "desc" === n.activeSort.order
                ? ((o.newSort = n.activeSort),
                  t.sortOperation(o),
                  t.printSort(!1, o),
                  (t.targets = o.newOrder))
                : (o.startOrder = o.newOrder = t.targets),
              (o.startFilter = o.newFilter = n.activeFilter),
              (o.startSort = o.newSort = n.activeSort),
              (o.startContainerClassName = o.newContainerClassName =
                n.activeContainerClassName),
          ...
          return (
            (o = t.callFilters("operationGetInitialState", o, [n])),
            (t.lastOperation = o),
        ...
        indexTargets: function () {
          ...
          if (t.dom.targets.length) {
            for (r = 0; (i = t.dom.targets[r]); r++)
              (o = new e.Target()).init(i, t, s ? s[r] : void 0),
                (o.isInDom = !0),
                t.targets.push(o);
            t.dom.parent =
        ...
        initControls: function () {
          ...
          for (l = 0; (n = e.controlDefinitions[l]); l++)
            if (t.config.controls.live || n.live) {
              ...
              for (c = 0; (i = r[c]); c++)
                (a = t.getControl(i, n.type, n.selector)), t.controls.push(a);
            } else
              for (
                o = s.querySelectorAll(t.config.selectors.control + n.selector),
                  c = 0;
                (i = o[c]);
                c++
              )
                (a = t.getControl(i, n.type, "")) && t.controls.push(a);
          t.callActions("afterInitControls", arguments);
        },
        getControl: function (t, o, i) {
          var s = this,
            r = null,
            a = -1;
          if ((s.callActions("beforeGetControl", arguments), !i))
            for (a = 0; (r = e.controls[a]); a++) {
              if (r.el === t && r.isBound(s))
                return s.callFilters("controlGetControl", null, arguments);
              if (r.el === t && r.type === o && r.selector === i)
                return (
                  r.addBinding(s),
          ...
          return (
            (r = new e.Control()).init(t, o, i),
            (r.classNames.base = n.getClassname(s.config.classNames, o)),
        ...
        getToggleSelector: function () {
          ...
          return (
            ...
            "" === (o = t.toggleArray.join(e)) &&
              (o = t.config.controls.toggleDefault),
            t.callFilters("selectorGetToggleSelector", o, arguments)
          );
        },
        buildToggleArray: function (t, e) {
          var o = this,
            i = "";
          if (
            (o.callActions("beforeBuildToggleArray", arguments), t && t.filter)
          )
          ...
          (i !== o.config.selectors.target && "all" !== i) || (i = ""),
            "or" === o.config.controls.toggleLogic
              ? (o.toggleArray = i.split(","))
              : (o.toggleArray = o.splitCompoundSelector(i)),
            (o.toggleArray = n.clean(o.toggleArray)),
            o.callActions("afterBuildToggleArray", arguments);
        },
        ...
        updateControls: function (t) {
          var o = this,
            ...
            r = -1;
          for (
            o.callActions("beforeUpdateControls", arguments),
              t.filter
                ? (s.filter = t.filter.selector)
                : (s.filter = o.state.activeFilter.selector),
              t.sort
                ? (s.sort = o.buildSortString(t.sort))
                : (s.sort = o.buildSortString(o.state.activeSort)),
              s.filter === o.config.selectors.target && (s.filter = "all"),
            ...
            i.update(s, o.toggleArray);
          o.callActions("afterUpdateControls", arguments);
        },
        ...
        insertTargets: function (t, o) {
          ...
          if (
            ...
            (s = i.getNextSibling(t.index, t.sibling, t.position)),
            (a = i.dom.document.createDocumentFragment()),
            (r = s ? n.index(s, i.config.selectors.target) : i.targets.length),
            t.collection)
          ) {
            for (d = 0; (c = t.collection[d]); d++) {
              ...
              (c.style.display = "none"),
                a.appendChild(c),
                a.appendChild(i.dom.document.createTextNode(" ")),
            ...
            i.dom.parent.insertBefore(a, s);
          }
          (o.startOrder = i.origOrder = i.targets),
        ...
        filterOperation: function (t) {
          ...
          for (
            ...
            (n = t.newFilter.collection
              ...
              e.evaluateHideShow(n, s, i, t);
          if (t.toRemove.length)
            for (r = 0; (s = t.show[r]); r++)
              t.toRemove.indexOf(s) > -1 &&
                (t.show.splice(r, 1),
                (o = t.toShow.indexOf(s)) > -1 && t.toShow.splice(o, 1),
                t.toHide.push(s),
                t.hide.push(s),
                r--);
        ...
        evaluateHideShow: function (t, e, n, o) {
          ...
          (s = i.callFilters("testResultEvaluateHideShow", t, r)),
        ...
        sortOperation: function (t) {
          ...
          if (
            ...
            (t.startOrder = o.targets),
            t.newSort.collection)
          ) {
            for (i = [], a = 0; (r = t.newSort.collection[a]); a++) {
              if (o.dom.targets.indexOf(r) < 0)
                throw new Error(e.messages.errorSortNonExistentElement());
              (s = new e.Target()).init(r, o), (s.isInDom = !0), i.push(s);
            }
            t.newOrder = i;
          } else
        ...
        compare: function (t, e, n) {
          var o = this,
            i = n.order,
            s = o.getAttributeValue(t, n.attribute),
            r = o.getAttributeValue(e, n.attribute);
          return (
            isNaN(1 * s) || isNaN(1 * r)
        ...
        getAttributeValue: function (t, n) {
          ...
          return (
            ...
            o.callFilters("valueGetAttributeValue", i || 0, arguments)
          );
        },
        printSort: function (e, o) {
          var i = this,
            s = e ? o.newOrder : o.startOrder,
            r = e ? o.startOrder : o.newOrder,
            ...
            p = -1;
          for (
            i.callActions("beforePrintSort", arguments), p = 0;
            (d = s[p]);
            p++
          )
            "absolute" !== (u = d.dom.el).style.position &&
              (n.removeWhitespace(u.previousSibling),
              u.parentElement.removeChild(u));
          for (
            (c = a ? a.previousSibling : i.dom.parent.lastChild) &&
              "#text" === c.nodeName &&
        ...
        parseSortString: function (t, o) {
          ...
          return i.callFilters("commandsParseSort", o, arguments);
        },
        parseEffects: function () {
          var t = this,
            n = "",
            o = t.config.animation.effectsIn || t.config.animation.effects,
          ...
          e.transformDefaults))
            e.transformDefaults[n] instanceof e.TransformData &&
              (t.parseEffect(n, o, t.effectsIn, t.transformIn),
        ...
        parseEffect: function (t, n, o, i, s) {
          var r = this,
            a = /\(([^)]+)\)/,
            l = -1,
            c = "",
          ...
          if (n.indexOf(t) < 0) "stagger" === t && (r.staggerDuration = 0);
            ...
            switch (
              ((l = n.indexOf(t + "(")) > -1 &&
                ((c = n.substring(l)), (d = a.exec(c)[1])),
              t)
            ) {
              case "fade":
                o.opacity = d ? parseFloat(d) : 0;
                break;
              case "stagger":
              ...
              default:
                if (
                  (s && r.config.animation.reverseOut && "scale" !== t
                    ? (o[t].value =
                        -1 * (d ? parseFloat(d) : e.transformDefaults[t].value))
                    : (o[t].value = d
                        ? parseFloat(d)
                ...
                } else o[t].unit = e.transformDefaults[t].unit;
        ...
        buildState: function (t) {
          var n = this,
            ...
            s = -1;
          for (
            n.callActions("beforeBuildState", arguments), s = 0;
            (i = n.targets[s]);
            s++
          )
            (!t.toRemove.length || t.toRemove.indexOf(i) < 0) &&
              o.targets.push(i.dom.el);
          for (s = 0; (i = t.matching[s]); s++) o.matching.push(i.dom.el);
          for (s = 0; (i = t.show[s]); s++) o.show.push(i.dom.el);
          for (s = 0; (i = t.hide[s]); s++)
            (!t.toRemove.length || t.toRemove.indexOf(i) < 0) &&
              o.hide.push(i.dom.el);
          return (
            (o.id = n.id),
            (o.container = n.dom.container),
        ...
        goMix: function (o, i) {
          ...
          return (
            ...
            i.toShow.length ||
              ...
              i.willChangeLayout ||
              (o = !1),
            i.startState.show.length || i.show.length || (o = !1),
            e.events.fire(
              "mixStart",
              s.dom.container,
              { state: i.startState, futureState: i.newState, instance: s },
              s.dom.document
            ),
            ...
            (r = s.userDeferred
              ? s.userDeferred
              : (s.userDeferred = n.defer(e.libraries))),
            (s.isBusy = !0),
            o && e.features.has.transitions
              ? (t.pageYOffset !== i.docState.scrollTop &&
                ...
                s.config.animation.applyPerspective &&
                  ((s.dom.parent.style[e.features.perspectiveProp] =
                    s.config.animation.perspectiveDistance),
                  (s.dom.parent.style[e.features.perspectiveOriginProp] =
                ...
                s.config.animation.animateResizeContainer &&
                  ...
                  (s.dom.parent.style.height = i.startHeight + "px"),
                s.config.animation.animateResizeContainer &&
                  i.startWidth !== i.newWidth &&
                  i.viewportDeltaX !== i.startWidth - i.newWidth &&
                  (s.dom.parent.style.width = i.startWidth + "px"),
                i.startHeight === i.newHeight &&
                  (s.dom.parent.style.height = i.startHeight + "px"),
                i.startWidth === i.newWidth &&
                  (s.dom.parent.style.width = i.startWidth + "px"),
        ...
        getStartMixData: function (n) {
          var o = this,
            i = t.getComputedStyle(o.dom.parent),
            s = o.dom.parent.getBoundingClientRect(),
            r = null,
            a = {},
            l = -1,
          ...
          for (l = 0; (r = n.toHide[l]); l++)
            (a = r.getPosData()), (n.toHidePosData[l] = { startPosData: a });
          (n.startX = s.left),
            (n.startY = s.top),
            (n.startHeight = o.incPadding
              ? s.height
              : s.height -
        ...
        getInterMixData: function (t) {
          var e = this,
            ...
            o = -1;
          for (
            e.callActions("beforeGetInterMixData", arguments), o = 0;
            (n = t.show[o]);
            o++
          )
            t.showPosData[o].interPosData = n.getPosData();
          for (o = 0; (n = t.toHide[o]); o++)
            t.toHidePosData[o].interPosData = n.getPosData();
        ...
        getFinalMixData: function (e) {
          var o = this,
            ...
            a = -1;
          for (
            o.callActions("beforeGetFinalMixData", arguments), a = 0;
            (r = e.show[a]);
            a++
          )
            e.showPosData[a].finalPosData = r.getPosData();
          for (a = 0; (r = e.toHide[a]); a++)
            e.toHidePosData[a].finalPosData = r.getPosData();
          for (
            (o.config.animation.clampHeight || o.config.animation.clampWidth) &&
              (o.dom.parent.style.height =
                o.dom.parent.style.width =
                o.dom.parent.style.overflow =
                  ""),
              o.incPadding || (i = t.getComputedStyle(o.dom.parent)),
              s = o.dom.parent.getBoundingClientRect(),
              e.newX = s.left,
              e.newY = s.top,
              e.newHeight = o.incPadding
                ? s.height
                : s.height -
                  parseFloat(i.paddingTop) -
                  parseFloat(i.paddingBottom) -
          ...
          e.willChangeLayout &&
            (n.removeClass(o.dom.container, e.newContainerClassName),
            n.addClass(o.dom.container, o.config.layout.containerClassName)),
            o.callActions("afterGetFinalMixData", arguments);
        },
        getTweenData: function (t) {
          var n = this,
            ...
            u = -1;
          for (
            n.callActions("beforeGetTweenData", arguments), d = 0;
            (o = t.show[d]);
            d++
          )
            for (
              (i = t.showPosData[d]).posIn = new e.StyleData(),
                ...
                i.posIn.opacity = o.isShown ? 1 : n.effectsIn.opacity,
                i.posOut.opacity = 1,
          ...
          for (d = 0; (o = t.toHide[d]); d++)
            for (
              (i = t.toHidePosData[d]).posIn = new e.StyleData(),
                i.posOut = new e.StyleData(),
                i.tweenData = new e.StyleData(),
                i.posIn.x = o.isShown ? i.startPosData.x - i.interPosData.x : 0,
                i.posIn.y = o.isShown ? i.startPosData.y - i.interPosData.y : 0,
        ...
        moveTargets: function (t) {
          var o = this,
            ...
            c = -1,
            d = -1,
            u = o.checkProgress.bind(o);
          for (
            o.callActions("beforeMoveTargets", arguments), d = 0;
            (i = t.show[d]);
            d++
          )
            (s = new e.IMoveData()),
              (r = t.showPosData[d]),
              (a = i.isShown ? "none" : "show"),
              (l = o.willTransition(a, t.hasEffect, r.posIn, r.posOut)) && c++,
              i.show(),
              (s.posIn = r.posIn),
              (s.posOut = r.posOut),
              (s.statusChange = a),
          ...
          for (d = 0; (i = t.toHide[d]); d++)
            (r = t.toHidePosData[d]),
              (s = new e.IMoveData()),
              (a = "hide"),
              (l = o.willTransition(a, r.posIn, r.posOut)),
              (s.posIn = r.posIn),
              (s.posOut = r.posOut),
              (s.statusChange = a),
              (s.staggerIndex = d),
          ...
          o.config.animation.animateResizeContainer &&
            ((o.dom.parent.style[e.features.transitionProp] =
              "height " +
            ...
            requestAnimationFrame(function () {
              t.startHeight !== t.newHeight &&
                ...
                (o.dom.parent.style.height = t.newHeight + "px"),
                t.startWidth !== t.newWidth &&
                  t.viewportDeltaX !== t.startWidth - t.newWidth &&
                  (o.dom.parent.style.width = t.newWidth + "px");
            })),
            t.willChangeLayout &&
              (n.removeClass(
                o.dom.container,
              ...
              n.addClass(o.dom.container, t.newContainerClassName)),
            o.callActions("afterMoveTargets", arguments);
        },
        hasEffect: function () {
          var t = this,
            e = [
          ...
          for (s = 0; (n = e[s]); s++)
            if (
              0 !== ("undefined" !== (o = t.effectsIn[n]).value ? o.value : o)
            ) {
              i = !0;
              break;
            }
        ...
        willTransition: function (t, e, o, i) {
          var s = this,
            r = !1;
          return (
            (r = !(
              !n.isVisible(s.dom.container) ||
              (!(("none" !== t && e) || o.x !== i.x || o.y !== i.y) &&
                (!s.config.animation.animateResizeTargets ||
                  (o.width === i.width &&
                    o.height === i.height &&
                    o.marginRight === i.marginRight &&
                    o.marginTop === i.marginTop)))
            )),
        ...
        cleanUp: function (t) {
          ...
          if (
            ...
            (o.dom.parent.style[e.features.transitionProp] =
              ...
              o.dom.parent.style[e.features.perspectiveOriginProp] =
                ""),
            t.willChangeLayout &&
              (n.removeClass(o.dom.container, t.startContainerClassName),
              n.addClass(o.dom.container, t.newContainerClassName)),
            t.toRemove.length)
          ) {
            for (l = 0; (i = o.targets[l]); l++)
              t.toRemove.indexOf(i) > -1 &&
                ((s = i.dom.el.previousSibling) &&
                  "#text" === s.nodeName &&
                  (r = i.dom.el.nextSibling) &&
                  "#text" === r.nodeName &&
                  n.removeWhitespace(s),
                t.willSort || o.dom.parent.removeChild(i.dom.el),
                o.targets.splice(l, 1),
                (i.isInDom = !1),
                l--);
          ...
          t.willSort && (o.targets = t.newOrder),
            ...
            o.queue.length &&
              ...
              (a = o.queue.shift()),
              (o.userDeferred = a.deferred),
              (o.isToggling = a.isToggling),
              (o.lastClicked = a.triggerElement),
              a.instruction.command instanceof e.CommandMultimix
                ? o.multimix.apply(o, a.args)
                : o.dataset.apply(o, a.args)),
        ...
        parseMultimixArgs: function (t) {
          var o = this,
            ...
            r = -1;
          for (
            i.animate = o.config.animation.enable,
            ...
            null !== (s = t[r]) &&
              ("object" == typeof s
                ...
                : "boolean" == typeof s
                ? (i.animate = s)
                : "function" == typeof s && (i.callback = s));
          return (
            !i.command.insert ||
              i.command.insert instanceof e.CommandInsert ||
              (i.command.insert = o.parseInsertArgs([
                i.command.insert,
              ]).command),
            !i.command.remove ||
              i.command.remove instanceof e.CommandRemove ||
              (i.command.remove = o.parseRemoveArgs([
                i.command.remove,
              ]).command),
            !i.command.filter ||
              i.command.filter instanceof e.CommandFilter ||
              (i.command.filter = o.parseFilterArgs([
                i.command.filter,
              ]).command),
            !i.command.sort ||
              i.command.sort instanceof e.CommandSort ||
              (i.command.sort = o.parseSortArgs([i.command.sort]).command),
            !i.command.changeLayout ||
              i.command.changeLayout instanceof e.CommandChangeLayout ||
              (i.command.changeLayout = o.parseChangeLayoutArgs([
                i.command.changeLayout,
              ]).command),
            (i = o.callFilters("instructionParseMultimixArgs", i, arguments)),
            n.freeze(i),
            i
          );
        },
        parseFilterArgs: function (t) {
          ...
          for (
            ...
            "string" == typeof (s = t[r])
              ? (i.command.selector = s)
              : null === s
              ? (i.command.collection = [])
              : "object" == typeof s && n.isElement(s, o.dom.document)
              ? (i.command.collection = [s])
              : "object" == typeof s && void 0 !== s.length
              ? (i.command.collection = n.arrayFromList(s))
              : "object" == typeof s
              ? n.extend(i.command, s)
              : "boolean" == typeof s
              ? (i.animate = s)
          ...
          return (
            (i = o.callFilters("instructionParseFilterArgs", i, arguments)),
            n.freeze(i),
            i
          );
        },
        parseSortArgs: function (t) {
            ...
            if (null !== (s = t[a]))
              switch (typeof s) {
                case "string":
                  ...
                  break;
                case "object":
                  s.length && (i.command.collection = n.arrayFromList(s));
                  break;
                case "boolean":
                  i.animate = s;
                  break;
          ...
          return (
            r && (i.command = o.parseSortString(r, i.command)),
            (i = o.callFilters("instructionParseSortArgs", i, arguments)),
            n.freeze(i),
            i
          );
        },
        parseInsertArgs: function (t) {
          ...
          for (
            ...
            null !== (s = t[r]) &&
              ("number" == typeof s
                ...
                ? (i.command.position = s)
                : "string" == typeof s
                ? (i.command.collection = n.arrayFromList(
                    n.createElement(s).childNodes
                  ))
                : "object" == typeof s && n.isElement(s, o.dom.document)
                ...
                ? i.command.collection.length
                  ? (i.command.sibling = s[0])
                  : (i.command.collection = s)
                : "object" == typeof s && s.childNodes && s.childNodes.length
                ? i.command.collection.length
                  ? (i.command.sibling = s.childNodes[0])
                  : (i.command.collection = n.arrayFromList(s.childNodes))
                : "object" == typeof s
                ? n.extend(i.command, s)
                : "boolean" == typeof s
                ? (i.animate = s)
          ...
          return (
            ...
            (i = o.callFilters("instructionParseInsertArgs", i, arguments)),
            n.freeze(i),
            i
          );
        },
        parseRemoveArgs: function (t) {
          ...
          for (
            ...
            if (null !== (r = t[a]))
              switch (typeof r) {
                case "number":
                  o.targets[r] && (i.command.targets[0] = o.targets[r]);
                  break;
                case "string":
                  i.command.collection = n.arrayFromList(
                    o.dom.parent.querySelectorAll(r)
                  );
                  break;
                case "object":
                  r && r.length
                    ? (i.command.collection = r)
                    : n.isElement(r, o.dom.document)
                    ? (i.command.collection = [r])
          ...
          if (i.command.collection.length)
            for (a = 0; (s = o.targets[a]); a++)
              i.command.collection.indexOf(s.dom.el) > -1 &&
                i.command.targets.push(s);
          return (
        ...
        parseDatasetArgs: function (t) {
          var o = new e.UserInstruction(),
            i = null,
            s = -1;
          for (
            o.animate = this.config.animation.enable,
              o.command = new e.CommandDataset(),
              s = 0;
            s < t.length;
            s++
          )
        ...
        parseChangeLayoutArgs: function (t) {
          ...
          for (
            o.animate = this.config.animation.enable,
              o.command = new e.CommandChangeLayout(),
              s = 0;
            s < t.length;
            s++
          )
            if (null !== (i = t[s]))
              switch (typeof i) {
                case "string":
                  o.command.containerClassName = i;
                  break;
                case "object":
                  n.extend(o.command, i);
                  break;
        ...
        queueMix: function (t) {
          var o = this,
            ...
            s = "";
          return (
            o.callActions("beforeQueueMix", arguments),
            (i = n.defer(e.libraries)),
            o.config.animation.queue &&
            o.queue.length < o.config.animation.queueLimit
              ? ((t.deferred = i),
                o.queue.push(t),
                o.config.controls.enable &&
                  (o.isToggling
                    ? (o.buildToggleArray(t.instruction.command),
                      (s = o.getToggleSelector()),
                      o.updateControls({ filter: { selector: s } }))
                    : o.updateControls(t.instruction.command)))
              : (o.config.debug.showWarnings &&
                ...
                "function" == typeof o.config.callbacks.onMixBusy &&
                  o.config.callbacks.onMixBusy.call(
                    o.dom.container,
                    o.state,
                    o
                  )),
            o.callFilters("promiseQueueMix", i.promise, arguments)
          );
        },
        getDataOperation: function (t) {
          ...
          if (
            ...
            o.dom.targets.length && !(s = o.state.activeDataset || []).length)
          )
            throw new Error(e.messages.errorDatasetNotSet());
          return (
            (i.id = n.randomHex()),
            (i.startState = o.state),
            (i.startDataset = s),
            ...
            o.config.animation.enable &&
              (o.getStartMixData(i),
              o.setInter(i),
              (i.docState = n.getDocumentState(o.dom.document)),
              o.getInterMixData(i),
              o.setFinal(i),
              o.getFinalMixData(i),
              o.parseEffects(),
              (i.hasEffect = o.hasEffect()),
              o.getTweenData(i)),
            (o.targets = i.show.slice()),
            (i.newState = o.buildState(i)),
            Array.prototype.push.apply(o.targets, i.toRemove),
            o.callFilters("operationMappedGetDataOperation", i, arguments)
          );
        },
        diffDatasets: function (t) {
          var o = this,
            ...
            h = -1;
          for (
            o.callActions("beforeDiffDatasets", arguments), h = 0;
            (a = t.newDataset[h]);
            h++
          ) {
            if (
              void 0 === (f = a[o.config.data.uidKey]) ||
              f.toString().length < 1
            )
              throw new TypeError(
                e.messages.errorDatasetInvalidUidKey({
                  uidKey: o.config.data.uidKey,
                })
              );
            if (p[f])
              throw new Error(e.messages.errorDatasetDuplicateUid({ uid: f }));
            (p[f] = !0),
              (l = o.cache[f]) instanceof e.Target
                ? (o.config.data.dirtyCheck &&
                    ...
                    c !== l.dom.el &&
                      (l.isInDom &&
                        (l.unbindEvents(),
                        o.dom.parent.replaceChild(c, l.dom.el)),
                      l.isShown || (c.style.display = "none"),
                      (l.dom.el = c),
                      l.isInDom && l.bindEvents())),
                  (c = l.dom.el))
                : ((l = new e.Target()).init(null, o, a), l.hide()),
              l.isInDom
                ? ((u = l.dom.el.nextElementSibling),
                  s.push(f),
                  d &&
                    (d.lastElementChild &&
                      d.appendChild(o.dom.document.createTextNode(" ")),
                    o.insertDatasetFrag(d, l.dom.el, r),
                    (d = null)))
                : (d || (d = o.dom.document.createDocumentFragment()),
                  d.lastElementChild &&
                    d.appendChild(o.dom.document.createTextNode(" ")),
          ...
          for (
            d &&
              ((u = u || o.config.layout.siblingAfter) &&
                d.appendChild(o.dom.document.createTextNode(" ")),
              o.insertDatasetFrag(d, u, r)),
              h = 0;
            (a = t.startDataset[h]);
            h++
          )
            (f = a[o.config.data.uidKey]),
              (l = o.cache[f]),
              t.show.indexOf(l) < 0
                ? (t.hide.push(l), t.toHide.push(l), t.toRemove.push(l))
                : i.push(f);
          n.isEqualArray(i, s) || (t.willSort = !0),
            o.callActions("afterDiffDatasets", arguments);
        },
        insertDatasetFrag: function (t, e, o) {
          var i = this,
            s = e
              ? n.arrayFromList(i.dom.parent.children).indexOf(e)
              : i.targets.length;
          for (i.dom.parent.insertBefore(t, e); o.length; )
            i.targets.splice(s, 0, o.shift()), s++;
        },
        ...
        toggleOff: function () {
          var t = this,
            e = t.parseFilterArgs(arguments),
            n = e.command.selector,
            o = t.toggleArray.indexOf(n),
            i = "";
          return (
            (t.isToggling = !0),
            o > -1 && t.toggleArray.splice(o, 1),
          ...
          return (
            ...
            t.isBusy
              ...
              : (n.callback && (t.userCallback = n.callback),
                ...
                (o = t.getDataOperation(n.command.dataset)),
                t.goMix(s, o))
          );
        },
        multimix: function () {
        ...
        getOperation: function (t) {
          ...
          return (
            ...
            (c.command = t),
            (c.startState = o.state),
            (c.triggerElement = o.lastClicked),
            o.isBusy
              ? (o.config.debug.showWarnings &&
                  console.warn(e.messages.warningGetOperationInstanceBusy()),
                null)
              : (l && o.insertTargets(l, c),
                a && (c.toRemove = a.targets),
                (c.startSort = c.newSort = c.startState.activeSort),
                (c.startOrder = c.newOrder = o.targets),
                i &&
                  ((c.startSort = c.startState.activeSort),
                  (c.newSort = i),
                  (c.willSort = o.willSort(i, c.startState.activeSort)),
                  c.willSort && o.sortOperation(c)),
                (c.startFilter = c.startState.activeFilter),
                (c.newFilter =
                  s || n.extend(new e.CommandFilter(), c.startFilter)),
                "all" === c.newFilter.selector
                  ? (c.newFilter.selector = o.config.selectors.target)
                ...
                o.config.animation.enable &&
                  (o.getStartMixData(c),
                  o.setInter(c),
                  (c.docState = n.getDocumentState(o.dom.document)),
                  o.getInterMixData(c),
                  o.setFinal(c),
                  o.getFinalMixData(c),
                  o.parseEffects(),
                  (c.hasEffect = o.hasEffect()),
                  o.getTweenData(c)),
                c.willSort && (o.targets = c.newOrder),
                (c.newState = o.buildState(c)),
                o.callFilters("operationMappedGetOperation", c, arguments))
          );
        },
        tween: function (t, e) {
          var n = null,
          ...
          for (
            ...
            (o = t.showPosData[s]), n.applyTween(o, e);
        ...
        getConfig: function (t) {
          var e = this,
            o = null;
          return (
            (o = t ? n.getProperty(e.config, t) : e.config),
            e.callFilters("valueGetConfig", o, arguments)
          );
        },
        ...
        getState: function () {
          ...
          return (
            ...
            n.extend(o, t.state),
            n.freeze(o),
            t.callFilters("stateGetState", o, arguments)
          );
        },
        ...
        destroy: function (t) {
          var n = this,
            ...
            s = 0;
          for (
            n.callActions("beforeDestroy", arguments), s = 0;
            (o = n.controls[s]);
            s++
          )
            o.removeBinding(n);
          for (s = 0; (i = n.targets[s]); s++) t && i.show(), i.unbindEvents();
      ...
      n.extend(e.Target.prototype, {
        ...
        init: function (t, n, o) {
          ...
          if (
            ...
            o && n.config.data.uidKey)
          ) {
            if (
              void 0 === (s = o[n.config.data.uidKey]) ||
              s.toString().length < 1
            )
              throw new TypeError(
                e.messages.errorDatasetInvalidUidKey({
        ...
        render: function (t) {
          var o = this,
            ...
            a = "";
          if (
            (o.callActions("beforeRender", arguments),
            "function" !=
              typeof (i = o.callFilters(
                "renderRender",
                o.mixer.config.render.target,
                arguments
              )))
          )
            throw new TypeError(e.messages.errorDatasetRendererNotSet());
          return (
            (a = i(t)) && "object" == typeof a && n.isElement(a)
              ? (s = a)
              : "string" == typeof a &&
                (((r = document.createElement("div")).innerHTML = a),
                (s = r.firstElementChild)),
            o.callFilters("elRender", s, arguments)
          );
        },
        cacheDom: function (t) {
          var e = this;
        ...
        applyTween: function (t, n) {
          ...
          for (
            ...
            if (((s = t.tweenData[i]), "x" === i)) {
              ...
              if (!s.value) continue;
              (l[i].value = r[i].value + s.value * n),
                (l[i].unit = s.unit),
                a.push(i + "(" + l[i].value + s.unit + ")");
            } else {
              if (!s) continue;
              (l[i] = r[i] + s * n), (o.dom.el.style[i] = l[i]);
            }
          (l.x || l.y) && a.unshift("translate(" + l.x + "px, " + l.y + "px)"),
            a.length &&
              (o.dom.el.style[e.features.transformProp] = a.join(" ")),
        ...
        applyStylesIn: function (t) {
          ...
          n.callActions("beforeApplyStylesIn", arguments),
            s.push("translate(" + o.x + "px, " + o.y + "px)"),
            n.mixer.config.animation.animateResizeTargets &&
              ("show" !== t.statusChange &&
                ((n.dom.el.style.width = o.width + "px"),
                (n.dom.el.style.height = o.height + "px")),
              (n.dom.el.style.marginRight = o.marginRight + "px"),
              (n.dom.el.style.marginBottom = o.marginBottom + "px")),
            i && (n.dom.el.style.opacity = o.opacity),
        ...
        writeTransitionRule: function (t, e, n) {
          ...
          return (
            (s =
              ...
              i +
              "ms " +
              ("opacity" === t ? "linear" : o.mixer.config.animation.easing)),
            o.callFilters("ruleWriteTransitionRule", s, arguments)
          );
        },
        getDelay: function (t) {
          var e = this,
        ...
        applyTransition: function (t) {
          ...
          n.callActions("beforeApplyTransition", arguments),
            (n.dom.el.style[e.features.transitionProp] = o),
        ...
        getPosData: function (n) {
          ...
          return (
            ...
            (r.x = o.dom.el.offsetLeft),
            (r.y = o.dom.el.offsetTop),
            (o.mixer.config.animation.animateResizeTargets || n) &&
              ((s = o.dom.el.getBoundingClientRect()),
              (r.top = s.top),
              (r.right = s.right),
              (r.bottom = s.bottom),
              (r.left = s.left),
      ...
      (e.Collection = function (t) {
        var e = null,
          o = -1;
        for (this.callActions("beforeConstruct"), o = 0; (e = t[o]); o++)
          this[o] = e;
    ...
    if (((t.console = t.console || { info: function (t) {} }), n))
      if (n.fn.fancybox) console.info("fancyBox already initialized");
        ...
        var i,
          ...
          y = function (t, e, o) {
            var i = this;
            (i.opts = m({ index: o }, n.fancybox.defaults)),
              n.isPlainObject(e) && (i.opts = m(i.opts, e)),
              n.fancybox.isMobile && (i.opts = m(i.opts, i.opts.mobile)),
              (i.id = i.opts.id || ++u),
        ...
        n.extend(y.prototype, {
            ...
            n.each(s, function (t, e) {
              ...
              n.isPlainObject(e)
                ...
                ? ((u = (s = n(e)).data() || {}),
                  ...
                  (d.src = i.opts.src || u.src || s.attr("href")),
          ...
          scaleToActual: function (t, e, i) {
            ...
            d.isAnimating ||
              ...
              (t = t === o ? 0.5 * f : t),
              (e = e === o ? 0.5 * h : e),
              ((s = n.fancybox.getTranslate(p)).top -= n.fancybox.getTranslate(
                u.$slide
              ).top),
          ...
          getFitPos: function (t) {
            ...
            return (
              ...
              (l && c) || ((l = e), (c = o)),
              (l *= i = Math.min(1, e / l, o / c)) > e - 0.5 && (l = e),
              (c *= i) > o - 0.5 && (c = o),
              "image" === t.type
                ? ((d.top =
                    Math.floor(0.5 * (o - c)) +
          ...
          isScaledDown: function (t, e) {
            ...
            return (
              t !== o && e !== o
                ...
                : r &&
                  (i =
                    (i = n.fancybox.getTranslate(r)).width < s.width &&
                    i.height < s.height),
              i
            );
          },
              ...
              "zoom" === e
                ? ((a.isAnimating = !0),
                  ...
                  "auto" == (r = t.opts.zoomOpacity) &&
                    (r =
                      Math.abs(t.width / t.height - d.width / d.height) > 0.1),
                  ...
                  e
                    ? (n.fancybox.stop(l),
                      ...
                      void n.fancybox.animate(
                        ...
                        s,
                        function () {
                          l.removeClass(i).css({ transform: "", opacity: "" }),
          ...
          trigger: function (t, e) {
            ...
            if (
              (r ? i.unshift(r) : (r = s),
              i.unshift(s),
              n.isFunction(r.opts[t]) && (o = r.opts[t].apply(r, i)),
              !1 === o)
            )
              return o;
            "afterClose" !== t && s.$refs
            ...
            return (
              (e = (t = t || {}).selector || !1)
                ? n("body")
                    ...
                    .on("click.fb-start", e, { options: t }, v)
      ...
      (t && t.isDefaultPrevented()) ||
        ...
        ((s = n.fancybox.getInstance()) && s.$trigger && s.$trigger.is(o)) ||
          ((r = e.selector
            ...
            : [o]),
          (a = n(r).index(o)) < 0 && (a = 0),
          ((s = n.fancybox.open(r, e, a)).$trigger = o)));
    }
      ...
      (r = t.extend(!0, {}, e, s.opts.media)),
        t.each(r, function (e, o) {
          if ((l = f.match(o.matcher))) {
            if (
              ((h = o.type), (p = e), (u = {}), o.paramPlace && l[o.paramPlace])
            ) {
            ...
            return (
              (c = t.extend(!0, {}, o.params, s.opts[e], u)),
              (f =
    ...
    (c.prototype.destroy = function () {
      ...
      (c.prototype.limitMovement = function () {
        ...
        return (
          ...
          d > 0 && s > e && (s = e - 1 + Math.pow(-e + f + d, 0.8) || 0),
      ...
      (c.prototype.onTap = function (e) {
        var o,
          ...
          a = i.instance,
          l = a.current,
          c = (e && s(e)) || i.startPoints,
          d = c[0] ? c[0].x - n(t).scrollLeft() - i.stagePos.left : 0,
          u = c[0] ? c[0].y - n(t).scrollTop() - i.stagePos.top : 0,
          p = function (t) {
            var o = l.opts[t];
            if ((n.isFunction(o) && (o = o.apply(a, [l, e])), o))
              switch (o) {
                case "close":
      ...
      e(t).on("click", "[data-fancybox-share]", function () {
        ...
        r &&
          ("function" === e.type(r.opts.share.url) &&
            (t = r.opts.share.url.apply(r, [s, r])),
          (n = r.opts.share.tpl
            .replace(
              /\{\{media\}\}/g,
            ...
            "beforeShow.fb": function (n, o, i, r) {
              ...
              i &&
                ...
                t.location.hash !== "#" + o.currentHash &&
                  (r && !o.origHash && (o.origHash = t.location.hash),
    ...
    $(".header__btn").on("click", () => {
      ...
      $(".contact-slider").slick({
        ...
        responsive: [
          ...
          { breakpoint: 928, settings: { slidesToShow: 4, slidesToScroll: 4 } },
          { breakpoint: 756, settings: { slidesToShow: 2, slidesToScroll: 2 } },
          {
            breakpoint: 600,
            settings: {
              slidesToShow: 1,
      ...
      $(".article-slider__box").slick({
        prevArrow:
          '<button type="button" class="slick-prev"> <img src="../images/blog/arrow_slider_left.svg" alt=""> </button>',
        nextArrow:
          '<button type="button" class="slick-next"> <img src="../images/blog/arrow_slider_rigth.svg" alt=""> </button>',
      });
    var t = document.querySelector(".gallery__inner");
    t &&
      mixitup(t, {
        load: { filter: ".category-b" },
        animation: { effects: "fade translateZ(-100px)" },
      });
    let e,
      n = document.querySelector(".gallery__inner-page");
    n &&
      (e = mixitup(n, { animation: { effects: "fade translateZ(-100px)" } }));
    document.querySelectorAll(".inspiration__item-line").forEach((t) => {
      (t.style.width = t
        .closest("li")
        .querySelector(".inspiration__item-num").textContent),
        parseInt(t.style.width) > 100 && (t.style.width = "100%");
    }),
      ...
      $(window).resize(() => {
        $(window).width() <= 563 &&
          $(".works-path__item--measurements").appendTo(
